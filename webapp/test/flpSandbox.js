		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#jpcosekisuiyfizp003-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jpcosekisuiyfizp003-display": {
								"semanticObject": "jpcosekisuiyfizp003",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jp.co.sekisui.yfizp003",
									"url": sap.ui.require.toUrl("jp/co/sekisui/yfizp003")
								}
							}
						}
					}
